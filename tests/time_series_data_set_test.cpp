...
TEST(TimeSeriesDataset, GeneralConstructor)
{
    ...
    TimeSeriesDataset time_series_data_set_3(1, input_shape, target_dimensions);
...
TEST(TimeSeriesDataset, CrossCorrelations)
{
    ...
    TimeSeriesDataset dataset(6, input_shape, target_dimensions);
...
TEST(TimeSeriesDataset, test_transform_time_series)
{
    ...
    TimeSeriesDataset dataset(9, input_shape, target_dimensions);
...
TEST(TimeSeriesDataset, test_set_steps_ahead_number)
{
    ...
    TimeSeriesDataset dataset(4, input_shape, target_dimensions);
